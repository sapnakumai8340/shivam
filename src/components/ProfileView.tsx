  ...
  return (
    <div className="min-h-screen bg-[#0b0f14] pb-28 pt-2 px-4 max-w-md mx-auto space-y-4">
      ...
      <div className="relative bg-[#151c24] border border-slate-800/90 rounded-3xl p-5 overflow-hidden shadow-2xl">
        ...
        <div
          className={`absolute -top-12 -right-12 w-64 h-64 rounded-3xl rotate-45 pointer-events-none ${
            isAdmin
        ...
        <div className="flex justify-center mb-3 relative">
          <div
            className={`w-32 h-32 rounded-full p-1 bg-gradient-to-tr shadow-lg relative group cursor-pointer ${
              isAdmin
          ...
          >
            ...
            <span
              className={`absolute bottom-1 right-2 w-4 h-4 rounded-full border-2 border-[#151c24] shadow-md ${
                isAdmin
                ...
                >
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-[10px] text-slate-400 font-semibold truncate">
                      {pl.position} • {pl.club || 'Apex Premier Squad'}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-1.5 shrink-0">
                  <span
                    className={`text-[9px] font-bold px-2 py-0.5 rounded-md uppercase font-mono ${
                      pl.adminDecision?.clearanceStatus === 'MATCH READY' || !pl.adminDecision
            ...
            <div className="flex items-baseline gap-2 mt-0.5">
              ...
              <span
                className={`text-sm font-black flex items-center ${
                  athlete.ratingChange >= 0 ? 'text-[#ff5500]' : 'text-rose-500'
                }`}
              >
        ...
        <div className="mt-3 bg-[#111822] border border-slate-800 rounded-xl p-3 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-300 mt-0.5 leading-relaxed">
              {athlete.name} registered rating baseline active at {athlete.overallRating.toFixed(1)} under Apex biomechanical tracking.
            </p>
          </div>
        </div>
      </div>
