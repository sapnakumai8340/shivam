        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2 max-w-2xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#ff5500]/15 border border-[#ff5500]/30 text-[#ff5500] text-[10px] font-black uppercase tracking-widest">
              ...
              <span>APEX SPORTS ACADEMY • 100% FREE LEARNING</span>
            </div>
          ...
          {isAdminOrCoach && (
            <div className="flex flex-wrap items-center gap-3 shrink-0">
              ...
              <button
                ...
                className={`px-4 py-3 rounded-2xl border text-xs font-black uppercase tracking-wider transition-all ${
                  ...
                  <tr key={course.id} className="hover:bg-slate-900/50 transition-colors">
                    ...
                    <td className="py-3.5 px-3">
                      <button
                        ...
                        className={`inline-flex items-center gap-1 text-[10px] font-black uppercase px-2 py-0.5 rounded-full border transition-all ${
                          course.isPublished
                  ...
                  >
                    ...
                    <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between space-y-3">
                      ...
                      <button
                        ...
                        className={`w-full py-2.5 rounded-2xl text-xs font-black uppercase tracking-wider flex items-center justify-center gap-1.5 transition-all mt-2 active:scale-98 ${
                          isEnrolled
                            ? isCompleted
