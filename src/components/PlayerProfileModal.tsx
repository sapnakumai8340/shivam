        ...
        <div className="overflow-y-auto p-4 space-y-4 text-xs">
          ...
          <div>
            ...
            <div className="text-[11px] text-[#ff5500] font-bold">
              {athlete.role} • {athlete.position} | {athlete.club || 'Apex Premier Squad'}
            </div>
          ...
          <div className="flex gap-2">
            <button
              ...
              className={`flex-1 py-2 px-4 rounded-xl font-black uppercase text-xs tracking-wider flex items-center justify-center gap-2 transition-all ${
                athlete.isFollowing
          ...
          <div className="grid grid-cols-3 border-t border-slate-800 pt-2 text-center">
            <button
              ...
              className={`py-2 flex items-center justify-center gap-1.5 text-xs font-bold uppercase transition-all ${
                activeTab === 'posts'
