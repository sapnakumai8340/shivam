                      ...
                      {[1.0, 1.25, 1.5, 2.0].map((s) => (
                        <button
                          ...
                          className={`px-1.5 py-0.5 text-[10px] font-mono font-bold rounded ${
                            playbackSpeed === s ? 'bg-[#ff5500] text-white' : 'text-slate-400 hover:text-white'
                          }`}
                        >
                          {s}x
                        </button>
              ...
              <div className="flex items-center justify-between p-3 bg-slate-900/80 rounded-2xl border border-slate-800">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] text-slate-400">{course.instructorTitle || 'Apex Performance Coach'}</p>
                  </div>
                </div>
                        ...
                        {chapter.lessons?.map((lesson) => {
                          ...
                          return (
                            <div
                              ...
                              className={`p-2.5 sm:p-3 flex items-center gap-3 cursor-pointer transition-all ${
                                isActive
